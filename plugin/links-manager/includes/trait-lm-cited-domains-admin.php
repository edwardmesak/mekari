...
trait LM_Cited_Domains_Admin_Trait {
  public function render_admin_cited_domains_page() {
    ...
    echo '<tr><th scope="row">' . esc_html__('Export', 'links-manager') . '</th><td><a class="button button-secondary" href="' . esc_url($exportUrl) . '">' . esc_html__('Export CSV', 'links-manager') . '</a><div class="lm-small">' . esc_html__('Export follows the current filters and includes source page + anchor text.', 'links-manager') . '</div></td></tr>';
    echo '</tbody></table>';
